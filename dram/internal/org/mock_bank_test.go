...
import (
	...
	sim0 "gitlab.com/akita/akita/v3/sim"
	signal "gitlab.com/akita/mem/v3/dram/internal/signal"
)
...
func (m *MockBank) GetReadyCommand(now sim0.VTimeInSec, cmd *signal.Command) *signal.Command {
	m.ctrl.T.Helper()
...
func (m *MockBank) StartCommand(now sim0.VTimeInSec, cmd *signal.Command) {
	m.ctrl.T.Helper()
...
func (m *MockBank) Tick(now sim0.VTimeInSec) bool {
	m.ctrl.T.Helper()
