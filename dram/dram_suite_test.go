...
//go:generate mockgen -destination "mock_trans_test.go" -package $GOPACKAGE -write_package_comment=false gitlab.com/akita/mem/v3/dram/internal/trans SubTransactionQueue,SubTransSplitter
...
//go:generate mockgen -destination "mock_org_test.go" -package $GOPACKAGE -write_package_comment=false gitlab.com/akita/mem/v3/dram/internal/org Channel
//go:generate mockgen -destination "mock_mem_test.go" -package $GOPACKAGE -write_package_comment=false gitlab.com/akita/mem/v3/mem AddressConverter
