...
import (
	...
	"gitlab.com/akita/mem/v3/dram/internal/cmdq"
	"gitlab.com/akita/mem/v3/dram/internal/org"
	"gitlab.com/akita/mem/v3/dram/internal/trans"
)
...
func (b Builder) Build(name string) *MemController {
	...
	m.topPort = sim.NewLimitNumMsgPort(m, 1, name+".TopPort")
